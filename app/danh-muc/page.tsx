    ...
    <div className="bg-slate-50 min-h-screen pb-20">
      ...
      <div className="bg-white border-b border-slate-200 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">Danh mục Sản phẩm</h1>
          <p className="text-slate-500 max-w-2xl mx-auto text-lg">Khám phá các bộ sưu tập nội thất tuyệt đẹp từ Tủ Nhựa Giá Rẻ, được thiết kế để nâng tầm không gian sống của bạn.</p>
        </div>
      </div>
                ...
                >
                  ...
                  <div className="absolute inset-0 p-6 sm:p-8 flex flex-col justify-end">
                    <div className="transform transition-transform duration-300 group-hover:-translate-y-2">
                      <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">{category.name}</h2>
